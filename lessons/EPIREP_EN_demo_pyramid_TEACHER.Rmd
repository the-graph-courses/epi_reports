...
![](images/final_pyramid.png){width="586"}
...
‣ A demographic pyramid helps visualize the distribution of a population by **age** and **sex**.

![](images/final_pyramid.png){width="637"}

‣ We are able to create pyramids with the {ggplot2} package.

::: side-note
**Side note**

The package {apyramid} is a product of the **R4Epis** project that allows for the rapid creation of population pyramids.
:::

## Why use population pyramids in epidemiology?

‣ Population pyramids visualize the distribution of disease by age and sex.

‣ This helps us describe and understand the epidemiology of various communicable diseases.
