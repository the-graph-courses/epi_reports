...
-   Use pie and donut charts sparingly, with a mindful eye on their potential to obscure the data's true story.
:::
...
tb_outcomes %>% 
  ...
  summarise(
    total_cases = sum(___________________)) %>% 
...
`r .tgc_contributors_list(ids = c("benn", "joy", "amckinley"))`
