...
‣ Addres aesthetic concerns with labeling a small area like the "Federal Capital Territory" on a map:
...
‣ Efficientl communication of two important pieces of information (cases per 10000 and increase rate)
...
‣ Sisualizing specific data points on a geographical map can provide crucial insights\
\
