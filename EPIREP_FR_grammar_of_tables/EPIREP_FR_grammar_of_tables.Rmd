...
::: reminder
**Rappel {gt} - Lignes de résumé**
Cette image montre le composant des lignes de résumé d'un tableau `{gt}`, clairement indiqué dans un carré rouge. Les lignes de résumé fournissent des données agrégées ou des résumés statistiques des données contenues dans les colonnes correspondantes.
![](images/gt_summary_rows.PNG)
:::
